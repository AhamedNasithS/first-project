...
export default function Banner() {
    return (
        <div className='px-[20px] sm:p-0 w-full sm:w-[92%] xl:w-[88%] mx-auto sm:flex gap-[40px] items-center relative xl:max-h-[350px]'>
            <img src='https://dz1x1c630cl14.cloudfront.net/webassets/articles_main1.svg' alt='articles' className='relative z-[1] sm:w-[50%] xl:w-auto' />
            ...
            <div className='flex flex-col gap-[30px] justify-between mt-[40px] sm:mt-0 sm:h-[250px] lg:h-[330px] xl:h-[350px] '>
                <h3 className='bg-gradient-to-r from-[#FFFFFF] to-[#FDD220] bg-clip-text text-transparent text-[18px] md:text-[22px] lg:text-[30px] xl:text-[40px] font-semibold relative z-[1] text-center sm:text-start'>Breaking Barriers in Communication and Collaboration with Workfast.ai</h3>
