...
import Articles1 from '../../../../images/articles_main1.svg';
...
export default function Banner() {
    return (
        <div className='w-[88%] mx-auto flex gap-[40px] items-center relative max-h-[350px]'>
            ...
            <div className='flex flex-col justify-between h-[350px]'>
                <h3 className='bg-gradient-to-r from-[#FFFFFF] to-[#FDD220] bg-clip-text text-transparent text-[22px] md:text-[28px] lg:text-[36px] xl:text-[40px] font-semibold relative z-[1]'>Breaking Barriers in Communication and Collaboration with Workfast.ai</h3>
