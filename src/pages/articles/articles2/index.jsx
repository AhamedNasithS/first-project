...
export default function Articles2() {
  ...
  return (
    <div className='flex flex-col justify-start items-center w-full bg-[#010306] relative gap-[30px] md:gap-[60px] lg:gap-[100px]'>
      ...
      <p className='text-[#E4E8EB] text-[15px] md:text-[18px] lg:text-[21px] xl:text-[26px] font-normal w-[88%] text-center'>The above Top 7 ways will be a saviour for many companies , project managers , CEO’s etc who are struggling to manage work and experiencing low productivity . This blog gave you a outlook of how it will be if you use Workfast.ai . if you really want to experience it , no other way use Workfast.ai , one platform which make you work faster and easier .</p>
      <div className='flex flex-col gap-[32px] xl:gap-[48px] px-[20px] sm:px-0 w-full md:w-[88%] relative z-[1] mx-auto'>
        ...
        <div className='flex flex-col md:flex-row gap-[20px] lg:gap-[28px] overflow-x-scroll justify-between w-full element-with-scrollbar'>
          ...
          <div className='rounded-[8px] sm:max-w-[300px] lg:max-w-[378px] flex flex-col shrink-0 cursor-pointer sm:mr-[20px] lg:mr-[28px]' onClick={() => { navigate('/blog/looking-for-a-new-platform-for-project-management') }}>
