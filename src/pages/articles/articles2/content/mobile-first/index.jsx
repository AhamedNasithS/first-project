...
export default function MobileFirst() {
    return (
        <div className='flex flex-col gap-[50px]'>
            ...
            <p className='text-[#E4E8EB] text-[26px] font-normal'>Whole lot of project management softwares comes in web view . In addition there is a mobile app as well . One pain point Workfast.ai Analysed was , “ Despite having mobile view , it is not UI/UX friendly”. </p>
            ...
            <p className='text-[#E4E8EB] text-[26px] font-normal'> <span className='font-semibold'>Firstly,</span> managers and above in an organisation are constantly on the move. It will be much easier to know whats happening inside the company or projects in realtime. This will be a true gift for them. </p>
            <p className='text-[#E4E8EB] text-[26px] font-normal'> <span className='font-semibold'>Secondly,</span> work from home is on rise and many company encourage employees working remotely . Mobile view immensely help employees to manage work and personal time efficiently . </p>
