...
export default function AiIntelligence() {
    return (
        <div className='flex flex-col gap-[15px] lg:gap-[30px] xl:gap-[50px]'>
            <h2 className='bg-gradient-to-r from-[#FFFFFF] to-[#FDD220] bg-clip-text text-transparent text-[21px] md:text-[24px] lg:text-[32px] xl:text-[45px] font-semibold relative z-[1] w-[120px] md:w-[170px] lg:w-[230px] xl:w-[326px]'>AI intelligence:</h2>
            <p className='text-[#E4E8EB] text-[15px] md:text-[18px] lg:text-[21px] xl:text-[26px] font-normal'>Now AI is the buzz word for any development. Software tools without AI stands behind the race . Only question arises to me is , “How great we can use AI for productivity and management” . Actually it is a wonderful combination.</p>
