...
export default function AiIntelligence() {
    return (
        <div className='flex flex-col gap-[15px] lg:gap-[30px] xl:gap-[50px]'>
            ...
            <p className='text-[#E4E8EB] text-[15px] md:text-[18px] lg:text-[22px] xl:text-[26px] font-normal'>Now AI is the buzz word for any development. Software tools without AI stands behind the race . Only question arises to me is , “How great we can use AI for productivity and management” . Actually it is a wonderful combination.</p>
