  ...
  return (
    <div className="">
          <div className="flex flex-col md:flex-row w-full min-h-screen bg-[#1E2430] overflow-hidden justify-center items-center">
            ...
            {/* Left Section */}
            <div
              className={`h-screen hidden md:w-1/2 md:flex mt-5 md:mt-0 justify-center items-center text-center bg-transparent md:bg-[#121825] ${
                backPage === "workSpaceName" || backPage === "channel"
                  ? ""
                  : "mx-2"
              }`}
            >
            ...
            <div className=" relative w-full md:w-1/2 flex justify-center items-center text-center bg-[#1E2430] mt-0 h-screen">
              ...
              <div className="text-white mt-10 md:mt-0 w-full">
                <div className="text-center mx-auto">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="w-10/12 md:w-full mx-auto flex">
                        <button
                          type="submit"
                          className={`bg-[#FFDE08] mb-0 md:mb-0 text-[#2A2500] text-base md:text-lg font-semibold md:font-bold mt-5 md:mt-10 w-full md:w-3/5 mx-auto px-4 md:px-6 py-3 rounded-md ${
                            isContinueDisabled
                    ...
                    >
                      <div className="text-start mt-3 md:mt-5 w-full md:w-4/6 mx-auto">
                        ...
                        <div className="w-11/12 md:w-full mx-auto">
                          ...
                          <div className="">
                            <button
                              className={`bg-[#FFDE08] mb-1 md:mb-0 text-[#2A2500] text-base md:text-lg font-semibold md:font-bold mt-6 md:mt-10 w-full mx-auto px-4 md:px-6 py-3 rounded-md ${
                                isContinueDisabled
                                  ? //   ? "md:opacity-50 cursor-not-allowed"
                                    ""
                                  : ""
                  ...
                  <div
                    className={`${
                      cropImageSectionVisible ? "" : "hidden"
                  ...
                  >
                    ...
                    <div className="flex text-center items-end mt-6 md:mt-10 w-11/12 md:w-10/12 mx-auto bg-[#1E2430] focus:outline-none border border-white ring-2 ring-[#4B5059] py-1 md:py-2 px-2 rounded-md">
                      ...
                      <div
                        className={`flex justify-end ${
                          inviteEmails.length <= 0 ? "mb-0" : "mb-2"
                        }`}
                      >
                    ...
                    <div className="w-full">
                      <button
                        className={`bg-[#FFDE08] text-[#2A2500] text-base md:text-lg font-[500] md:font-[600] mt-6 md:mt-10 w-11/12 md:w-6/12 mx-auto px-4 md:px-6 py-3 rounded-md ${
                          inviteEmails.length <= 0 || buttonLoading
                            ? "md:opacity-50"
                            : ""
                        }`}
