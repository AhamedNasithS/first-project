            ...
            {isOpen ? (
                <div className={`rounded-b-[20px] bg-gradient-to-t from-[#111830] to-[#13131300] z-[15] fixed top-0 left-0 right-0 pb-[20px]`}>
                    ...
                    <div className='w-9/12 mx-auto mt-6'>
                        ...
                        <button className='py-[8px] px-[12px] text-[#1B1600] text-[14px] sen-bold rounded-[8px] bg-gradient-to-bl from-[#FDD01F] via-[#F8C240] to-[#F8861B] mb-6' onClick={(e) => { handleSubmit(e) }}>Sign up for free</button>
