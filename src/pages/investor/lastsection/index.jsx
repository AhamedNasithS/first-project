...
import InvestorsScreenshot from "../../../images/Investors_screenshot.svg";
import InvestorsScreenshot1 from "../../../images/Investors_screenshot1.svg";
import InvestorsScreenshot2 from "../../../images/Investors_screenshot2.svg";
import InvestorsScreenshot3 from "../../../images/Investors_Screenshot3.svg";
    ...
    return (
        <div className="h-full w-full flex flex-col items-center relative overflow-hidden px-[20px] sm:px-[40px] gap-[40px] sm:gap-[70px] lg:gap-[140px]">
            ...
            <div className='w-11/12 mx-auto flex justify-between relative p-[30px]'>
                <img src={Confetti} alt='confetti' className='absolute inset-[0px] z-[0]' />
                <img src={InvestorsScreenshot1} alt='confetti' className='relative z-[1] investors1 w-[25%] xl:w-auto' />
                <img src={InvestorsScreenshot2} alt='confetti' className='relative z-[1] investors2  w-[25%] xl:w-auto' />
                <img src={InvestorsScreenshot3} alt='confetti' className='relative z-[1] investors1  w-[25%] xl:w-auto' />
                <img src={InvestorsScreenshot} alt='confetti' className='relative z-[1] investors2  w-[25%] xl:w-auto' />
            </div>
