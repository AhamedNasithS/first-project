...
export default function Intro() {
    ...
    return (
        <div className="bg-cover bg-center h-full w-full flex flex-col items-center relative" style={{ backgroundImage: `url(https://dz1x1c630cl14.cloudfront.net/webassets/background.svg)` }}>
            <h2 className='text-[70px] text-[#FFFFFF] font-bold mt-[40px]'>One intelligent Platform</h2>
            <h2 className='text-[70px] bg-gradient-to-l from-[#FDD220] to-[#FFFFFF] bg-clip-text text-transparent font-bold'>for your team to work faster</h2>
                ...
                <div className='w-[140px] h-[55px]'>
                    <div className='w-full h-full animate bg-transparent p-[1px] relative z-[1] border-[#3E3E3E] border-[1px] rounded-[8px]'>
                        <div className='w-full h-full p-[6px] bg-[#000] relative z-[5] rounded-[8px]'>
                            <button className='w-full h-full rounded-[8px] bg-gradient-to-bl from-[#FDD01F] via-[#FDD320] to-[#F8861B] border-[1px] border-[#995900] text-[#2A2200] text-[16px] font-medium'>Book a Demo</button>
                        </div>
                    </div>
                </div>
            </div>
