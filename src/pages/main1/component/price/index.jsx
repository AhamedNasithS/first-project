            ...
            {toggleValue === "Month" ? (
                <div className='flex sm:grid grid-cols-2 xl:flex flex-col lg:flex-row gap-[30px] mt-[20px] lg:mt-[40px]'>
                    ...
                    <div className={`p-5 w-full lg:w-[320px] border-[1px] border-[#FFFFFF1A] rounded-[10px] lg:rounded-[30px] hover:scale-[1.1] transition-all duration-700 relative overflow-hidden ${knowMoreB4M ? "h-[860px] lg:h-[1100px]" : "h-[380px] lg:h-[500px]"}`}>
                        ...
                        <button className='w-10/12 lg:w-[170px] h-[45px] absolute z-[1] bottom-4 left-[50%] -translate-x-[50%] bg-gradient-to-bl from-[#FDD01F] via-[#FDD320] via-[#F8C240] to-[#F8861B] rounded-[5px] lg:rounded-[10px] text-[#2A2200] font-medium text-[16px] border-[1px] border-[#FFE784]' onClick={() => { setIsForm(true) }}>Contact Sales</button>
                    </div>
                </div>
            ) : toggleValue === "Year" && (
                <div className='flex sm:grid grid-cols-2 xl:flex flex-col lg:flex-row gap-[30px] mt-[20px] lg:mt-[40px]'>
