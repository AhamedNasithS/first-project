...
export default function Pricing({setIsForm}) {
    ...
    return (
        <div className="flex flex-col items-center relative w-10/12 mx-auto my-[20px] lg:mt-[100px]" id='pricing'>
            ...
            <div className='p-[3px] lg:p-1 bg-[#2B2D37] rounded-[28px] flex items-center mt-[10px] lg:mt-[20px]'>
            ...
            {toggleValue === "Month" ? (
                <div className='flex sm:grid grid-cols-2 xl:flex flex-col lg:flex-row gap-[30px] mt-[20px] lg:mt-[40px]'>
                    <div className='p-5 w-full lg:w-[320px] h-[300px] lg:h-[400px] border-[1px] border-[#FFFFFF1A] rounded-[10px] lg:rounded-[30px] my-auto hover:scale-[1.1] transition-all duration-700' style={{ background: 'url(https://dz1x1c630cl14.cloudfront.net/webassets/card.svg)' }}>
                        ...
                        <button className='w-full lg:w-[170px] h-[45px] lg:ml-[50px] mt-[60px] lg:mt-[40px] bg-gradient-to-bl from-[#FDD01F] via-[#FDD320] via-[#F8C240] to-[#F8861B] rounded-[5px] lg:rounded-[10px] text-[#2A2200] font-medium text-[16px] border-[1px] border-[#FFE784]' onClick={() => {setIsForm(true)}}>Get Started</button>
                    </div>
                    <div className='p-5 w-full lg:w-[320px] h-[300px] lg:h-[400px] border-[1px] border-[#FFFFFF1A] rounded-[10px] lg:rounded-[30px] hover:scale-[1.1] transition-all duration-700' style={{ background: 'url(https://dz1x1c630cl14.cloudfront.net/webassets/card.svg)' }}>
                        <div className='p-1 rounded-[10px] bg-[#303018] w-6/12 ml-auto text-center'>
                            <h3 className='font-bold text-[#FFDD09] text-[10px]'>MOST POPULAR</h3>
                        </div>
                        <h2 className='text-[#FFFFFF] text-[20px] lg:text-[36px] font-bold lg:ml-[20px]'>$13 <span className='text-[#BCBCBC] text-[10px] lg:text-[16px] font-medium'>User/month</span></h2>
                        <h3 className='text-[#FFFFFF] text-[18px] lg:text-[30px] font-medium my-[5px] lg:my-[20px] lg:ml-[20px]'>Basecamp 2</h3>
                        <div className='flex gap-2 items-center lg:ml-[20px] my-[10px]'>
                            <img src={tik} alt='tik' className='w-[15px] lg:w-auto' />
                        ...
                        <button className='w-full lg:w-[170px] h-[45px] lg:ml-[65px] mt-[30px] lg:mt-[20px] bg-gradient-to-bl from-[#FDD01F] via-[#FDD320] via-[#F8C240] to-[#F8861B] rounded-[5px] lg:rounded-[10px] text-[#2A2200] font-medium text-[16px] border-[1px] border-[#FFE784]' onClick={() => {setIsForm(true)}}>Get Started</button>
                    </div>
                    <div className='p-5 w-full lg:w-[320px] h-[300px] lg:h-[400px] border-[1px] border-[#FFFFFF1A] rounded-[10px] lg:rounded-[30px] my-auto hover:scale-[1.1] transition-all duration-700' style={{ background: 'url(https://dz1x1c630cl14.cloudfront.net/webassets/card.svg)' }}>
                        ...
                        <button className='w-full lg:w-[170px] h-[45px] lg:ml-[50px] bg-gradient-to-bl from-[#FDD01F] via-[#FDD320] via-[#F8C240] to-[#F8861B] rounded-[5px] lg:rounded-[10px] text-[#2A2200] font-medium text-[16px] border-[1px] border-[#FFE784]' onClick={() => {setIsForm(true)}}>Get Started</button>
                    </div>
                    <div className='p-5 w-full lg:w-[320px] h-[300px] lg:h-[400px] border-[1px] border-[#FFFFFF1A] rounded-[10px] lg:rounded-[30px] my-auto hover:scale-[1.1] transition-all duration-700' style={{ background: 'url(https://dz1x1c630cl14.cloudfront.net/webassets/card.svg)' }}>
                        ...
                        <button className='w-full lg:w-[170px] h-[45px] lg:ml-[50px] mt-[10px] bg-gradient-to-bl from-[#FDD01F] via-[#FDD320] via-[#F8C240] to-[#F8861B] rounded-[5px] lg:rounded-[10px] text-[#2A2200] font-medium text-[16px] border-[1px] border-[#FFE784]' onClick={() => {setIsForm(true)}}>Get Started</button>
                    </div>
                </div>
            ) : toggleValue === "Year" && (
                <div className='flex sm:grid grid-cols-2 xl:flex flex-col lg:flex-row gap-[30px] mt-[20px] lg:mt-[100px]'>
                    ...
                    <div className='p-5 w-full lg:w-[320px] h-[300px] lg:h-[480px] border-[1px] border-[#FFFFFF1A] rounded-[10px] lg:rounded-[30px]' style={{ background: 'url(https://dz1x1c630cl14.cloudfront.net/webassets/card.svg)' }}>
                        <div className='lg:mt-[10px] p-1 rounded-[10px] bg-[#303018]'>
                            <h3 className='font-bold text-[#FFDD09] text-[10px]'>MOST POPULAR</h3>
                        </div>
                        <h2 className='text-[#FFFFFF] text-[20px] lg:text-[36px] font-bold lg:mt-[10px] lg:ml-[20px]'>$12 <span className='text-[#BCBCBC] text-[10px] lg:text-[16px] font-medium'>User/month</span></h2>
