...
export default function IpadView() {
    ...
    const images = [
        'https://dz1x1c630cl14.cloudfront.net/webassets/tapscreen1.webp',
        'https://dz1x1c630cl14.cloudfront.net/webassets/tapscreen2.webp',
        'https://dz1x1c630cl14.cloudfront.net/webassets/tapscreen3.webp'
    ];
    ...
    return (
        <div className="flex flex-col items-center relative px-[20px] lg:px-0 lg:w-10/12 mx-auto mb-[20px] lg:mb-[100px]">
            <div className="bg-cover bg-center bg-no-repeat relative w-[300px] h-[300px] md:w-[700px] md:h-[700px] px-7 py-10 overflow-hidden z-10" style={{ backgroundImage: `url(https://dz1x1c630cl14.cloudfront.net/webassets/icontab.webp)`, backgroundSize: '100% 72%' }}>
                <div className='w-full h-full overflow-hidden  flex items-center '>
                    <img src="https://dz1x1c630cl14.cloudfront.net/webassets/tapscreen1.webp" alt='ipad' className={`w-full h-full object-contain transition-transform duration-[1s] ease-in-out relative z-[0] ${currentImage === 0 ? 'translate-x-0' : '-translate-x-[110%]'}`} />
                    <img src="https://dz1x1c630cl14.cloudfront.net/webassets/tabscreen2.webp" alt='ipad' className={`w-full h-full object-contain transition-transform duration-[1s] ease-in-out relative z-[0] ${currentImage === 0 ? "translate-x-[100%]" : currentImage === 1 ? '-translate-x-[100%]' : '-translate-x-[210%]'}`} />
