...
export default function Intro() {
    ...
    return (
        <div className="bg-cover bg-center h-full w-full flex flex-col items-center relative mb-[100px]" style={{ backgroundImage: `url(https://dz1x1c630cl14.cloudfront.net/webassets/background.svg)` }}>
            ...
            <img src='https://dz1x1c630cl14.cloudfront.net/webassets/intro.svg' alt='intro' className='mt-[50px]' />
        </div>
    )
}
