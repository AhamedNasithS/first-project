...
return (
  <div className='flex flex-col justify-start items-center w-full h-full bg-[#010306] relative overflow-hidden px-0'>
    ...
    <Intro setIsForm={setIsForm}/>
    <Features />
    <img src='https://dz1x1c630cl14.cloudfront.net/webassets/mobiles.webp' alt='mobileView' data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="10000" className='my-[20px] lg:my-[100px] p-[20px] w-[80%]' />
    <Channel />
    <Project />
    <Task />
    <Chat />
