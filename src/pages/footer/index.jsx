...
export default function Footer() {
    ...
    const handleEmailClick = () => {
        window.location.href = 'https://mail.google.com/mail/?view=cm&fs=1&to=support@workfast.ai';
    };
                    ...
                    <div>
                        <div className='flex gap-[15px] lg:gap-[20px] items-center sm:justify-end mt-[20px] sm:mt-0'>
                            ...
                            <div className='text-center flex items-center justify-center gap-[5px]'>
                                ...
                                <h1 className='font-light text-[#FEF9F1] text-[13px] lg:text-[16px]' onClick={handleEmailClick}>support@workfast.ai</h1>
                            </div>
                        </div>
