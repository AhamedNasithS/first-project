...
export default function MainScreen({ setIsForm }) {
  return (
    <div className='flex flex-col justify-center items-center w-10/12 relative'>
      ...
      <img src='https://dz1x1c630cl14.cloudfront.net/webassets/workfast.svg' alt='logo' className='relative z-[1]' />
      ...
      <p className='text-[#FFFFFF] inter-normal text-[14px] lg:text-[18px] md:w-[63%] text-center my-[20px] relative z-[1]'>An Intelligent platform that helps your team to organise, collaborate and engage your work in a faster and easy way</p>
