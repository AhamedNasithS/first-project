        ...
        <div className='flex flex-col justify-center items-center w-10/12 relative z-[1] mx-auto'>
            ...
            <div className='mt-[20px] md:mt-[40px] lg:w-10/12 xl:w-11/12 grid md:grid-cols-2 md:gap-[60px]'>
                <div className='w-full xl:w-[458px] rounded-[20px] sm:rounded-[34px] p-[1px] bg-gradient-to-br from-[#1F44C5]/[80%] to-[#22398700]'>
                    <div className='w-full h-full rounded-[20px] sm:rounded-[34px] bg-[#010306] p-[5px] sm:p-[10px]'>
                        <div className='w-full h-full rounded-[16px] sm:rounded-[30px] bg-gradient-to-bl from-[#10192C29] via-[#101B2E8F] to-[#29457B00] p-[20px] border-[1px] border-[#1F44C5]/[40%] flex flex-col gap-[20px]'>
                ...
                <img src='https://dz1x1c630cl14.cloudfront.net/webassets/ilustrater.webp' alt='ilustrater' className='w-[80%] xl:w-[70%] mt-[20px] md:mt-[130px] lg:mt-[150px] xl:mt-0 mx-auto md:mx-[0px]'/>
            </div>
        </div>
    )
}