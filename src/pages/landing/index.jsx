...
export default function Landing() {
    ...
    return (
        <div className='flex flex-col justify-start items-center w-full h-full bg-[#010306] relative overflow-hidden px-[20px] p-0'>
            ...
            {/* <div className='w-full border-b-[1px] border-t-[1px] border-[#403D39] py-[20px] mb-[100px] flex justify-center gap-[40px] items-center'>
                <h1 className='font-normal text-[20px] text-[#FEF9F1]'>Together we will create a history</h1>
                <button className='h-[45px] w-[170px] bg-[#FDD320] rounded-[6px] text-[#0E1014] text-[14px] font-medium'>Apply for investment</button>
            </div> */}
