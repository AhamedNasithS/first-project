...
export default function Choose({setIsForm,setEmail ,email}) {
    ...
    return (
        <div className='relative w-11/12 mx-auto flex flex-col justify-center items-center gap-[45px] overflow-hidden mt-[100px]'>
            <h2 className='bg-clip-text text-transparent bg-gradient-to-l from-[#FDD220] to-[#FFFFFF] font-semibold text-[55px] text-center w-10/12'>When you can work fast in one platform , Why spending on multiple tools ?</h2>
            <div className='mt-[35px] bg-[#0F162F80] border-[1px] border-[#E2E8FF66] rounded-[30px] px-[72px] py-[22px]'>
                <h3 className='text-[#FEF9F1] text-[38px] font-normal'>Choose <a href='https://workfast.ai'><span class="glitter-text text-[#FFDD09] underline ">https://workfast.ai</span></a> with just <span className='text-[#FFDD09]'>$7</span></h3>
            </div>
