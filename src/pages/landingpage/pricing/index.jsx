        ...
        <div className='relative px-[20px] md:px-0 w-full md:w-11/12 mx-auto flex flex-col justify-center items-center mt-[30px] md:mt-[60px] lg:mt-[100px] overflow-hidden'>
            ...
            <div className='bg-[#0B1017] py-[40px] px-[36px] lg:py-[53px] rounded-[47px] mt-[65px] justify-between w-[500px] lg:w-[720px] hidden md:flex'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <h3 className='text-[12px] md:text-[16px] lg:text-[26px] text-[#FFFFFF] font-semibold'>$636</h3>
            ...
            <h2 className='text-[20px] font-bold text-[#FFFFFF] mt-[30px] text-center'>Introducing Our All-in-One Intelligent Platform, where you can manage Communication,<span className='bg-clip-text text-transparent bg-gradient-to-l from-[#FDD220] to-[#FFFFFF]'> Collaboration and Productivity</span></h2>
            <div className='bg-[#0B1017] py-[40px] px-[36px] lg:py-[53px] rounded-[47px] mt-[65px] justify-between w-[500px] lg:w-[720px] hidden md:flex'>
                {/* <div className='flex items-center justify-between'>
                    <h3 className='text-[18px] md:text-[22px] lg:text-[26px] text-[#FDD220] font-medium'>Monthly / <span className='text-[12px] md:text-[16px] lg:text-[20px] text-[#FFFFFFCC] font-normal'>Per user </span></h3>
                    c
