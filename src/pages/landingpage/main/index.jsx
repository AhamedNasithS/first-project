...
export default function Main({setIsForm,setEmail ,email}) {
    ...
    return (
        <div className='relative px-[20px] md:px-0 w-full md:w-11/12 mx-auto flex flex-col justify-center items-center gap-[10px] md:gap-[20px] lg:gap-[45px] overflow-hidden'>
            ...
            <img src={iconGroup} alt='iconGroup' className='relative md:z-[30] mt-[30px] md:mt-[60px] lg:mt-[100px] w-[80%] md:w-[70%] xl:w-auto' />
            <h2 className='bg-clip-text text-transparent bg-gradient-to-br from-[#FFFFFF] to-[#71717A] font-bold text-[22px] md:text-[28px] lg:text-[36px] xl:text-[50px] text-center'>Using Multiple Software tool to manage your work </h2>
