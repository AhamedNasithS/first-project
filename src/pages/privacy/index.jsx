  ...
  return (
    <div className='w-full h-screen relative p-10'>
      ...
      <div>
        ...
        <h4 className='text-[14px] sm:text-[20px] lg:text-[28px] text-[#FFF] font-normal mt-[30px] z-10 relative'><span className='bg-gradient-to-l from-[#FDD220] to-[#FFFFFF] bg-clip-text text-transparent'>workfasr.ai</span> may change this Policy periodically and we urge you to check this page for the latest version of the Policy in order to keep yourself updated.</h4>
      </div>
      <div>
      ...
      <div>
         ...
         <p className='text-[12px] sm:text-[18px] lg:text-[26px] text-[#FFF] font-nnormal mt-[20px] z-10 relative'><span className='text-[#FDD320] font-medium'>Withdrawal of your Consent </span>- You can choose not to provide your data, at any time while availing our goods or services or otherwise withdraw your consent provided to us earlier, in writing to our email ID: payments@get1.aiIn the event you choose to not provide or later withdraw your consent, we may not be able to provide you our services or goods.Please note that these rights are subject to our compliance with applicable laws.</p>
      </div>
      <div>
