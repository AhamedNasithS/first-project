  ...
  return (
    <div className='w-full h-screen relative p-10'>
      ...
      <div>
        ...
        <h4 className='text-[14px] sm:text-[20px] lg:text-[28px] text-[#FFF] font-normal mt-[30px] z-10 relative'><span className='bg-gradient-to-l from-[#FDD220] to-[#FFFFFF] bg-clip-text text-transparent'>1.Ai</span> may change this Policy periodically and we urge you to check this page for the latest version of the Policy in order to keep yourself updated.</h4>
      </div>
      <div>
