            ...
            {isOpen ? (
                <div className={`rounded-b-[20px] bg-gradient-to-t from-[#111830] to-[#13131300] z-[15] fixed top-0 left-0 right-0`}>
                    ...
                    <div className='w-9/12 mx-auto mt-6'>
                        ...
                        <div className={`mr-[40px] text-[#E2E8FF] py-[10px] mb-6 cursor-pointer rounded-[5px]`}>
                            <h1 className="font-medium text-1xl">Enterprice</h1>
                        </div>
                        <button className='py-[8px] px-[12px] w-full text-[#1B1600] mb-6 text-[14px] font-semibold rounded-[8px] bg-gradient-to-bl from-[#FDD01F] via-[#FDD320] via-[#F8C240] to-[#F8861B]'>Book a demo</button>
                    </div>
                </div>
            ) : (
